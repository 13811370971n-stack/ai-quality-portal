...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'visual', id: 'shift', caption: '规格不动，分布中心右移 1.5σ；该侧余量由 3σ 压到 1.5σ' },
      {
        kind: 'text',
        body:
          '中心一旦右移 1.5σ，靠近 USL 的一侧只剩 1.5σ 余量，该侧不良率从 1,350 PPM 升到约 66,807 PPM；另一侧虽然变宽，但正态分布尾部是指数衰减的，减少的量远补不上增加的量。',
      },
      {
        kind: 'callout',
        tone: 'insight',
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'visual', id: 'sixSigma', caption: '规格放到 ±6σ（总宽 12σ），漂移 1.5σ 后近侧仍余 4.5σ' },
      {
        kind: 'callout',
        tone: 'note',
        body:
