...
export default function RunChartTool() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-2xl font-bold text-mckinsey-navy mb-1">📈 运行图</h1>
      <p className="text-sm text-mckinsey-muted mb-6">Run Chart</p>
